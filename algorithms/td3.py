...
class PixelReplayBuffer(object):
    ...
    def add(self, state, action, next_state, reward, done):
        # FIX: .cpu() added to move incoming GPU tensors before storing in CPU buffer.
...
class Td3Trainer(Trainer):
    ...
    def collect_rollout(self) -> dict:
        ...
        with torch.no_grad():
            ...
            # Get state features - NO CLIPPING, just normalize
            ...
            # Concatenate visual + normalized state for full observation
